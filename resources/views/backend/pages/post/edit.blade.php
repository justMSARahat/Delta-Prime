                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $post->title }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="inputStatus"
                                    ...
                                    @foreach ( App\Models\Backend\category::orderBy('title','asc')->where('status',1)->where('parent',0)->get() as $parent )
                                        <option @if( $post->category  == $parent->id  ) selected @endif value="{{ $parent->id }}">{{ $parent->title }}</option>

                                        @foreach ( App\Models\Backend\category::orderBy('title','asc')->where('parent',$parent->id)->get() as $child_one )
                                            <option @if( $post->category  == $child_one->id  ) selected @endif value="{{ $child_one->id }}">-{{ $child_one->title }}</option>

                                            @foreach ( App\Models\Backend\category::orderBy('title','asc')->where('parent',$child_one->id)->get() as $chile_two )
                                                <option @if( $post->category  == $chile_two->id  ) selected @endif value="{{ $chile_two->id }}">--{{ $chile_two->title }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="inputStatus"
                                    ...
                                    @foreach ( $brand as $brand )
                                        <option @if( $post->brand == $brand->id ) selected @endif value="{{ $brand->id }}">{{ $brand->title }}</option>
                                    @endforeach
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" class="form-control @error('tag') is-invalid @enderror" name="tag" value="{{ $post->tag }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select id="inputStatus"
                                    ...
                                    <option @if( $post->status == 2 ) selected @endif value="2">On Hold</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="inputStatus"
                                    ...
                                    name="comment_opt">
                                    <option selected="" disabled="">Select one</option>
                                    <option @if( $post->comment_opt == 1 ) selected @endif value="1">Enabled</option>
                                    <option @if( $post->comment_opt == 2 ) selected @endif value="2">Disabled</option>
                                </select>
                            </div>
