    ...
    <section class="content">
        ...
        <div class="card">
                    ...
                    <tbody>
                        ...
                        @foreach ( $state as $item )
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td><a> {{ $item->name }}</a> </td>
                                <td><a> {{ $item->country_name->name }}</a> </td>
                                ...
                                <td class="project-actions text-center">
                                    <a class="btn btn-info btn-sm" href="{{ route('state.edit',$item->id) }}">
            ...
            <div class="card-footer clearfix">
                {!! $state->links('vendor.pagination.custom_2') !!}
            </div>
            <!-- /.card-body -->
        </div>
        <!-- /.card -->

        <a href="{{ route('state.create') }}" class="btn btn-primary" style="margin: 10px 0"> ADD NEW STATE</a>
