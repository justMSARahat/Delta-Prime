            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Featured Prodduct</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <form action="{{ route('feature.store') }}" method="Post" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="inputName">Featured Title</label>
            ...
            <div class="row">
                <div class="col-12" style="margin-bottom:20px">
                    <input type="submit" value="Add New Featured Product" class="btn btn-success float-right">
                </div>
            </div>
            <!-- Modal -->
