            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="basic-login">
                    ...
                    {{-- <form method="POST" action="{{ route('admin.password.update') }}">
                        ...
                        <input id="name" type="email" placeholder="Email address..." name="email"
                    ...
                    <form method="POST" action="{{ route('admin.password.update') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input id="email" type="email" placeholder="Email address..." name="email"
                                    class="@error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" required
                                    autocomplete="email" autofocus />
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="name">{{ __('Password') }}<span>**</span></label>
                                <input id="password" type="password" name="password" class="@error('password') is-invalid @enderror"  required autocomplete="new-password" autofocus/>
                        ...
                        <button  type="submit" class="os-btn w-100">  {{ __('Reset Password') }}</button>
                    </form>
                </div>
            </div>
        </div>
