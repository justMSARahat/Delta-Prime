...
@section('meta')
    @foreach ( App\Models\Backend\pageheader::orderBy('title','asc')->where('page','product-search')->get() as $header )
                    ...
                    <div class="shop__content-area">
                        ...
                        <div class="shop__header d-sm-flex justify-content-between align-items-center mb-40">
                            <div class="shop__header-left">
                                    <div class="show-text">
                                        <span>Showing {{($result->currentpage()-1)*$result->perpage()+1}} - {{$result->currentpage()*$result->perpage()}} of {{$result->total()}} results</span>
                                    </div>
                            </div>
                        ...
                        @else
                            <span class="alert alert-danger" style="display: block">Opps!!! No Product Found.</span>
                        @endif
